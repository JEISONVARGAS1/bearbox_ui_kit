  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: InkWell(
        ...
        splashColor: MyFitUiKit.util.color.primary.withOpacity(0.1),
        highlightColor: MyFitUiKit.util.color.primary.withOpacity(0.05),
        child: Container(
          padding: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
          decoration: BoxDecoration(
            color: isSelected
                ? MyFitUiKit.util.color.primary.withOpacity(0.1)
                : Colors.transparent,
            borderRadius: BorderRadius.circular(12),
            border: Border.all(
              color: isSelected
                  ? MyFitUiKit.util.color.primary.withOpacity(0.3)
                  : MyFitUiKit.util.color.primary.withOpacity(0.1),
              width: 1,
            ),
          ),
          child: Text(
            ...
            style: MyFitUiKit.util.textStyle.text.copyWith(
              color: isSelected
                  ...
                  : MyFitUiKit.util.color.textColor.withOpacity(0.7),
